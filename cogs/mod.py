...
class Moderation(commands.Cog):
    ...
    async def softban(self,ctx,member:discord.Member,*,reason="None"):
        ...
        if canban(ctx,author):
            ...
            await member.unban(reason=f"Manual softban by {author} for reason:\n{reason}")
    ...
    async def tempban(self,ctx,member:discord.Member,duration,*,reason="None"):
        ...
        duration=d
        if canban(ctx,author):
            await member.ban(reason=f"Manual tempban by {author} for duration:{duration} and reason:\n{reason}")
    ...
    async def mute(self,ctx,member:discord.Member,d="10",*,reason="None"):
        ...
        if candelete(ctx,author):
            ...
            await ctx.send(f"Muted {member} for duration: {duration}\nreason:\n{reason}")
